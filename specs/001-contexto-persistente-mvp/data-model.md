...
class ContextExpiredError extends Error {
  constructor(public readonly contextId: ContextId, public readonly expirationDate: Date) {
    super(`Context ${contextId} expired on ${expirationDate.toISOString()}`);
  }
}

class MessageTooLongError extends Error {
  constructor(public readonly contentLength: number, public readonly maxLength: number) {
